...
parser.add_argument('-r', dest='protpos', help='Input prot_pos file to give the list of BB and SC', default="restraints/prot_pos.txt")
...
if inputs.rest == 'yes':         system = restraints(system, crd, inputs, args.protpos)
